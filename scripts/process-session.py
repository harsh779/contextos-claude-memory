...
from contextos_index import (
    ...
    latest_technical_signals,
    project_index_signals,
    latest_memory_update,
    estimate_tokens as estimate_tokens_from_text,
    update_project_index as _update_project_index,
)
...
def update_project_index():
    return _update_project_index(VAULT)
